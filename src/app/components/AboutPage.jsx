...
export default function AboutPage() {
  return (
    <div name="About" className='w-full p-16 h-fit flex justify-center items-center flex-col'>
      <h1 className='text-3xl font-bold p-2 border-b-4 border-red-500 font-serif'>About</h1>
